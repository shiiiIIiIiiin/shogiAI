...
**駒割り:**
- 歩: 100点 / 香・桂: 300点 / 銀: 400点 / 金: 500点
- 角: 700点 / 飛: 800点 / 王: 100000点
- 成駒: と・成香・成桂: 500点 / 成銀: 600点 / 馬・龍: 900点

**位置評価（PST）:**
- 各駒種ごとに位置ボーナスを付与（前進・中央・囲い位置など）
- 飛車は前進で大きなボーナス（活用促進）
- 王は自陣奥+端寄りで控えめなボーナス（最大12点、囲い誘導）

**玉の安全度:**
- 隣接8マスの味方駒数を評価（飛車・龍は除外、1駒あたり+25点）

### 探索深さ

- **Python版**: 固定 depth = 5
- **C++版**: 反復深化（時間制限内で可能な限り深く探索）
  - Floodgate（10分+10秒フィッシャー）では depth 6〜8 程度

### 時間制御

- 反復深化で深さ1から順に探索、時間切れで中断
- 序盤（30手目まで）は時間を節約して中終盤に配分
- 残り時間が少ない場合は自動で短縮
